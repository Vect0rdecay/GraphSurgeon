...
Findings for these types keep descriptive titles until a registry entry exists in
`nn_security_analyzer/research/gadget_registry.py` and is synced to GraphSurgeon.
